<x-layouts.base>
    ...
    @guest
        @if (Request::is('register') || Request::is('static-sign-up'))
            <div class="flex flex-wrap -mx-3">
                <div class="w-full max-w-full px-3 flex-0">
                    @include('layouts.navbars.guest.nav')
                </div>
            ...
            {{ $slot }}
        @elseif (Request::is('login') || Request::is('login/forgot-password') || Request::is('static-sign-in') || Request::is('reset-password/*'))
        <div class="container sticky top-0 z-sticky">
            <div class="flex flex-wrap -mx-3">
                <div class="w-full max-w-full px-3 flex-0">
                    @include('layouts.navbars.guest.nav')
