        ...
        <div class="flex flex-wrap -mx-3">
            ...
            <div class="flex-none w-auto max-w-full px-3 my-auto">
                <div class="h-full">
                    ...
                    <p class="mb-0 font-semibold leading-normal text-size-sm">Subtitle</p>
                </div>
            </div>
            ...
            <div class="flex-auto p-4">
                ...
                <form action="/user-profile" method="POST">
                    ...
                    <div class="flex flex-wrap -mx-3">
                        ...
                        <div class="max-w-full px-3 lg:w-1/2 lg:flex-none">
                            <div class="flex flex-col h-full">
                                ...
                                <h6 class="font-bold leading-tight uppercase text-size-xs text-slate-500">Phone number
                                </h6>
                                ...
                                <h6 class="font-bold leading-tight uppercase text-size-xs text-slate-500">Location</h6>
                    ...
                    <div class="mb-4">
                        <textarea rows="4"
                            class="text-size-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                            placeholder="Say something about yourself" name="about_me">{{ auth()->user()->about_me }}
                    </textarea>
