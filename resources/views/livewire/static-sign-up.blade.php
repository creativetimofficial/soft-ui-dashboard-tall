              ...
              <div class="relative z-0 flex flex-col min-w-0 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border">
                ...
                <div class="flex flex-wrap px-3 -mx-3 sm:px-6 xl:px-12">
                  ...
                  <div class="relative w-full max-w-full px-3 mt-2 text-center shrink-0">
                    <p class="z-20 inline px-4 mb-2 font-semibold leading-normal bg-white text-size-sm text-slate-400">or</p>
                  </div>
                </div>
                <div class="flex-auto p-6">
                  <form role="form text-left">
                    ...
                    <div class="min-h-6 pl-6.92-em mb-0.5 block">
                      ...
                      <label class="mb-2 ml-1 font-normal cursor-pointer select-none text-size-sm text-slate-700" for="terms"> I agree the <a href="javascript:;" class="font-bold text-slate-700">Terms and Conditions</a> </label>
                    </div>
                    ...
                    <p class="mt-4 mb-0 leading-normal text-size-sm">Already have an account? <a href="{{ url('static-sign-in') }}" class="font-bold text-slate-700">Sign in</a></p>
                  </form>
                </div>
              </div>
            </div>
